...
public class QuantificationConstraint {
	...
	public QuantificationConstraint(String line, InstanceList instances, int yIdx, int xIdx, String type, String quantifierExpression, Boolean featureNegation, Boolean labelNegation){
